It checks the data in RDF graphs - which subject, predicates and objects may appear in the graph in what combination and with what cardinalities and datatypes.
